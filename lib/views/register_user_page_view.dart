...
class RegisterUserPageView extends StatefulWidget {
  const RegisterUserPageView({super.key});

  @override
  State<RegisterUserPageView> createState() => _RegisterUserPageViewState();
}
  ...
  Future<void> register() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Compte utilisateur créé !")),
      );
